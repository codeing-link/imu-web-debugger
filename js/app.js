...
window.MEMSApp = (() => {
    ...
    const pages = {
        ...
        'attitude': { module: () => window.AttitudePage, navId: 'nav-attitude' },
    };
    ...
    function initControls() {
        ...
        document.getElementById('nav-attitude')?.addEventListener('click', () => navigateTo('attitude'));
    }
